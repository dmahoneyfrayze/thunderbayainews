...
const styles = {
  ...
  glow1: { position: 'absolute', top: '-5%', left: '-5%', width: '500px', height: '500px', background: 'radial-gradient(circle, hsla(192, 91%, 32%, 0.08) 0%, transparent 70%)', filter: 'blur(80px)', pointerEvents: 'none', zIndex: 1 },
  glow2: { position: 'absolute', top: '15%', right: '-8%', width: '500px', height: '500px', background: 'radial-gradient(circle, hsla(262, 68%, 48%, 0.08) 0%, transparent 70%)', filter: 'blur(90px)', pointerEvents: 'none', zIndex: 1 },
  ...
  cardFeatured: { borderColor: 'hsla(192, 91%, 32%, 0.35)', boxShadow: '0 0 26px hsla(192, 91%, 32%, 0.12)' },
  ...
  metaRow: { display: 'flex', justifyContent: 'space-between', borderTop: '1px solid hsla(var(--border-light))', paddingTop: '16px', marginBottom: '18px', gap: '12px' },
