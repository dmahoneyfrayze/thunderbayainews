...
export const POSTS = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: 'ul', items: [
        'Up to 75% of eligible project costs covered, to a reported maximum in the range of $250,000 for qualifying projects.',
  ...
  {
    slug: 'noic-costarter-2026-deadline-checklist',
    title: 'NOIC Costarter 2026: the $18K accelerator deadline, and what to have ready',
    dek: 'The Northwestern Ontario Innovation Centre runs a 12-week accelerator with seed funding and mentorship. The next intake closes October 15, 2026 — here is the readiness checklist.',
    category: 'Programs',
    date: 'June 20, 2026',
    iso: '2026-06-20',
    readMins: 4,
    accent: ['#7b61ff', '#b800ff'],
    blocks: [
      { type: 'p', text: 'Costarter is the Northwestern Ontario Innovation Centre’s accelerator for early-stage, scalable ventures. Unlike a broad grant, it is a structured 12-week program — seed funding, co-working space, and intensive mentoring — designed to take a founder from idea toward a validated, fundable company.' },
      { type: 'h2', text: 'The shape of it' },
      { type: 'ul', items: [
        'Up to $18,000 in seed funding plus mentorship and workspace.',
        'A 12-week, full-time commitment from the founder — this is not a passive cheque.',
        'Next intake deadline: October 15, 2026.',
      ]},
      ...
      { type: 'callout', text: 'A 12-week full-time program is a real commitment. The strongest applications come from founders who can name what they will validate in those weeks — not just that they want the funding.' },
      ...
      { type: 'ul', items: [
        ...
        'What the 12 weeks would prove — the specific milestone you would hit.',
