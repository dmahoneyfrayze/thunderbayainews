...
const styles = {
  ...
  glow: {
    ...
    background: 'radial-gradient(circle, hsla(192, 91%, 32%, 0.10) 0%, hsla(262, 68%, 48%, 0.06) 45%, transparent 72%)',
  },
  ...
  lead: { fontSize: '18px', color: 'hsl(var(--text-secondary))', lineHeight: 1.6, marginBottom: '8px' },
  ...
  p: { fontSize: '16px', color: 'hsl(var(--text-secondary))', lineHeight: 1.75, marginBottom: '14px' },
  ul: { listStyle: 'none', margin: '0 0 14px', padding: 0, display: 'flex', flexDirection: 'column', gap: '10px' },
  li: { display: 'flex', gap: '12px', fontSize: '16px', color: 'hsl(var(--text-secondary))', lineHeight: 1.6 },
  ...
  note: { marginTop: '52px', paddingTop: '24px', borderTop: '1px solid hsla(var(--border-light))', fontSize: '14px', color: 'hsl(var(--text-muted))', fontStyle: 'italic' },
};
